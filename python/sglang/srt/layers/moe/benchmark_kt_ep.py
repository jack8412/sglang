...
def setup_minimal_server_args(model_path: str):
    ...
    # Create a minimal ServerArgs with required model_path and publish it as
    # the process-wide config (legacy set_global_server_args_for_scheduler is
    # ratcheted at the pin; publish() is the canonical entry point).
