...
Ported verbatim from kvcache-ai/sglang (ktfork commit b31c4dfeb1)
test/manual/quant/run_v4_mxfp4_layerwise_e2e.py — no sglang imports.
Manual script — not registered for CI.
"""
