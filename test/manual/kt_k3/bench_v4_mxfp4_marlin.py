...
Ported from kvcache-ai/sglang (ktfork commit b31c4dfeb1)
test/manual/quant/bench_v4_mxfp4_marlin.py; imports resolve unchanged in
this tree.  Manual script — not registered for CI.
